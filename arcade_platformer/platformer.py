...
class Platformer(arcade.Window):
    def __init__(self) -> None:
        ...
        self.coin_sound = arcade.load_sound(str(ASSETS_PATH / "sounds" / "coin.ogg"))
        self.jump_sound = arcade.load_sound(str(ASSETS_PATH / "sounds" / "jump.ogg"))
    ...
    def setup(self):
        ...
        game_map = arcade.load_tilemap(str(map_path))
